...
import { Heart, ShoppingCart, Filter, Grid, List, ChevronRight, Home } from "lucide-react";
...
const products = [
  ...
  {
    id: 2,
    name: "Роза «Белоснежка»",
    type: "Рассада",
    description: "Элегантная белая роза для торжественных случаев",
  ...
  {
    id: 3,
    name: "Роза «Персиковый Закат»",
    type: "Семена",
    description: "Нежные персиковые оттенки для романтичного сада",
  ...
  {
    id: 4,
    name: "Роза «Розовая Мечта»",
    type: "Луковицы",
    description: "Нежно-розовая роза с долгим цветением",
  ...
  {
    id: 5,
    name: "Роза «Золотое Сияние»",
    type: "Рассада",
    description: "Уникальная желтая роза с золотистым отливом",
    image: "https://images.unsplash.com/photo-1563241527-3004b7be0ffd?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    price: "520 ₽",
    originalPrice: null,
    isNew: true,
    isPopular: true,
  ...
  {
    id: 6,
    name: "Роза «Лиловый Туман»",
    type: "Семена",
    description: "Редкая фиолетовая роза с необычным окрасом",
    image: "https://images.unsplash.com/photo-1582794543139-8ac9cb0f7b11?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    price: "650 ₽",
    originalPrice: null,
    isNew: true,
    isPopular: false,
  ...
  {
    id: 7,
    name: "Роза «Малиновый Бархат»",
    type: "Луковицы",
    description: "Глубокий малиновый цвет с бархатистыми лепестками",
    image: "https://images.unsplash.com/photo-1518621012806-19718d6eeffe?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    price: "440 ₽",
    originalPrice: "520 ₽",
    isNew: false,
    isPopular: true,
  ...
  {
    id: 8,
    name: "Роза «Кремовая Нежность»",
    type: "Рассада",
    description: "Изысканная кремовая роза для утонченных натур",
    image: "https://images.unsplash.com/photo-1561181286-d52888359fee?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    price: "380 ₽",
    originalPrice: null,
    isNew: false,
    isPopular: false,
  ...
  {
    id: 9,
    name: "Роза «Огненная Страсть»",
    type: "Семена",
    description: "Яркая оранжево-красная роза с интенсивным цветом",
    image: "https://images.unsplash.com/photo-1455690378663-615551044797?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    price: "320 ₽",
    originalPrice: "400 ₽",
    isNew: false,
    isPopular: false,
    ...
    <div className="py-8 bg-white min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>Категории</span>
          <ChevronRight className="w-4 h-4" />
          <span className="text-[#CD8567] font-medium">Розы</span>
        </nav>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-4xl font-medium text-gray-800 mb-2">Розы</h1>
          ...
          <div className="bg-gradient-to-r from-[#FDF8F5] to-[#F4E4D6] rounded-2xl p-6">
            <p className="text-gray-700 leading-relaxed">
              Откройте для себя мир прекрасных роз в садовом центре "Сады Рассвета". 
              От классических красных до экзотических фиолетовых - у нас есть розы на любой вкус. 
              Все растения проходят тщательный отбор и гарантируют высокую всхожесть.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 p-4 bg-[#FDF8F5] rounded-2xl">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center space-x-2">
              <Filter className="w-4 h-4 text-[#CD8567]" />
            ...
            >
              ...
              <div className={`relative overflow-hidden ${
                ...
                <div className="absolute top-3 left-3 flex flex-col gap-2">
                  {product.isNew && (
                    <Badge className="bg-[#CD8567] text-white">NEW</Badge>
                  )}
                  {product.isPopular && (
                    <Badge className="bg-[#B8714C] text-white">ХИТ</Badge>
                  )}
                  {product.isSale && (
                    <Badge className="bg-red-500 text-white">СКИДКА</Badge>
                  )}
                </div>
                ...
                <div className="absolute bottom-3 left-3">
                  <Badge 
                    ...
                    className={product.stock === 'В наличии' 
