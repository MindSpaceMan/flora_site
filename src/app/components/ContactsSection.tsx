              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4 p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors shadow-sm">
                      <div className="w-14 h-14 bg-[#CD8567] rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div className="bg-gradient-to-br from-[#F4E4D6] to-[#CD8567] rounded-2xl p-8 text-center shadow-lg">
                  <h4 className="text-xl font-medium text-white mb-3">Флора Микс</h4>
                  <p className="text-white/90 text-base">Мы всегда на связи и готовы помочь вам с выбором растений</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center">
              <div className="bg-[#FDF8F5] rounded-2xl p-10 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <span className="text-sm text-gray-600 leading-relaxed">
                        ...
                        <Link href="/privacy" className="text-[#CD8567] hover:text-[#B8714C] underline transition-colors">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-[#CD8567] hover:bg-[#B8714C] text-white py-4 text-lg font-medium transition-colors mt-6"
                  >
                    Отправить сообщение
                  </Button>
                </form>
